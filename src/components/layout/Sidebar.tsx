        ...
        <div style={{ padding: '20px 20px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              <p style={{ fontSize: 14, fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{userName}</p>
              <span style={{
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <button
            ...
            style={{
              ...
              padding: '16px 20px', fontSize: 14, color: '#64748b',
          ...
          <div style={{ padding: '0 20px 16px', fontSize: 10, color: '#475569' }}>
